...
class ExceptionHandlerTest extends TestCase{
   ...
   */
  public function testSetLangOk(string $lang){
   ...
   * @covers Exceptions\ExceptionHandler::setLang
   */
  public function testSetLangFail(string $lang){
    try{
      ExceptionHandler::setLang($lang);
    }catch(\Exception $e){
   ...
   */
  public function testSetTemplateOk(string $file){
   ...
   */
  public function testSetTemplateFail(string $file){
    try{
      ExceptionHandler::setTemplate($file);
    }catch(\Exception $e){
      $this->assertInstanceOf(\Exception::class, $e);
